...
const CACHE = "mrisim-v4";                  // bump when this file's caching logic changes
const SHELL = [
  ...
  // Optional accounts layer (config.js may be absent — allSettled tolerates it).
  "config.js", "accounts.js", "account.html", "account.js",
];
