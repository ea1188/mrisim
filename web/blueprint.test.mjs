...
test("PREMIUM_MAP: exactly the 20 audited premium topics, each mapped to a valid category", () => {
  ...
  assert.deepEqual(counts, { "image-production": 9, procedures: 8, safety: 1, "patient-care": 2 });
});
