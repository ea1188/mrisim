...
class RegionMixin(_Base):
    ...
    def on_region_change(self) -> None:
        ...
        if name not in self._region_cache:
            ...
            # body atlases' A-P (axis 1) is already correct and must NOT be flipped:
            # an earlier axis-(1,2) flip mirrored knee/spine/abdomen A-P (patella
            # posterior, vertebral bodies on the wrong side) while the convention-placed
            # orientation letters made it look right. Verified by rendering the atlases.
